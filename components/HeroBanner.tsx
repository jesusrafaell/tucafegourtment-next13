...
const HeroBanner = (): JSX.Element => {
	...
	return (
		...
		>
			...
			>
				<div>
					<img src='/image/coffee-shop.jpg' className='aspect-[16/10] md:aspect-auto object-cover' />
					<div className={button_Carousel}>Shop now</div>
				</div>

				<div>
					<img src='/image/coffee-shop2.jpg' className='aspect-[16/10] md:aspect-auto object-cover' />
					<div className={button_Carousel}>Shop now</div>
				</div>
				{/* 
				<div>
